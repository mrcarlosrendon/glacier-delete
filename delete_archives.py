...
Usage: delete_archives.py [vault_name] [account_id] [archive_json_file]
"""
...
argparser.add_argument("account", help="AWS Account ID")
...
def delete_boto(archive):
    ...
    client.delete_archive(vaultName='backup', archiveId=archive_id)
